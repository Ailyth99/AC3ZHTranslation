...
class ColorInfoDialog(wx.Dialog):
    def __init__(self, parent, color):
        super().__init__(parent, title="Color Information")
        panel = wx.Panel(self)
        
        color_info = f"RGB: ({color[0]}, {color[1]}, {color[2]})"
        self.color_text = wx.TextCtrl(panel, value=color_info, style=wx.TE_READONLY)
